...
impl Node {
    ...
    pub fn set_first_child(&mut self, child: Option<Rc<RefCell<Node>>>) {
        self.firest_child = child;
    }

    pub fn first_child(&self) -> Option<Rc<RefCell<Node>>> {
        self.firest_child.as_ref().cloned()
    }

    pub fn set_last_child(&mut self, child: Weak<RefCell<Node>>) {
    ...
    pub fn set_previous_sibling(&mut self, sibling: Weak<RefCell<Node>>) {
    ...
    pub fn set_next_sibling(&mut self, sibling: Option<Rc<RefCell<Node>>>) {
...
impl Element {
    pub fn new(element_name: &str, attributes: Vec<Attribute>) -> Self {
        Self {
            kind: ElementKind::from_str(element_name).expect("Invalid element name"),
            attributes,
        }
    }
